...
public class PatientRegisterRequest {
    ...
    @UniqueCredential(role="patient", field = "passportNumber", message = "Користувач з таким номером паспорту вже існує")
    private String passportNumber;

    @NotNull(message = "Пошта є обов'язковим полем")
    @Email(message = "Неправильний формат пошти")
    @UniqueCredential(role="patient", field = "email", message = "Користувач з такою поштою вже існує")
    ...
    @UniqueCredential(role="patient", field = "phoneNumber", message = "Користувач з таким номером телефону вже існує")
